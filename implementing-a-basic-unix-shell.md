...
## Program Set-Up
The shell source code will be written in a single file called `shell.c`.  The following code block demonstrates the structure of the shell. Subsequent sections will introduce the prototypes and implementations.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwOTA3ODU0MywtMTE5NDQ1MjQ0MywtMT
...
NDcsLTU3MTEzMDY1MSwtODYzMjU2NTYsLTE1MzY5NzI4ODcsLT
IwODQ2NTI4NzUsLTE1MDMxMDQ0OTAsMTQ3MTQzOTcyMywyNDc5
NTg3NDVdfQ==
-->