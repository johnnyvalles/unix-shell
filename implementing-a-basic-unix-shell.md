...
> Quick Tip:  compile the shell using gcc (e.g. `gcc shell.c -o shell`). Debugging information can be generated by passing the `-g` option to `gcc` for use with `gdb`. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTIwNTM4OTAsLTExOTQ0NTI0NDMsLT
